...
- **Hent fra Vinmonopolet** — 🍷-knappen ved varenummer-feltet fyller ut navn, årgang, type, «passer til» og etikettbilde automatisk
...
3. ✅ Hente detaljer automatisk fra varenummeret (uten API-nøkkel — leser produktsiden på vinmonopolet.no direkte)
